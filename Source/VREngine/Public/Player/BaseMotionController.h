...
public:
	...
	/* Enables the visability of a ghost mesh representing the player's hand through an object.*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Haptic Effects")
		UHapticFeedbackEffect_Curve* RumbleHapticEffect;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Player Input | Controller")
		EMotionControllerType ControllerType = EMotionControllerType::ValveIndex;
	...
	*/
	...
	/*
	Get's the closest item to the controller in range.
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Haptic Effects")
		void RumbleController(UHapticFeedbackEffect_Curve* HapticEffect, float Intensity, bool bLoop);
	...
	/*
	Get's the current location of the TeleportCylinderComp and rotation of TeleportRotation.
	@param Location - Varaible used to store the return location.
	@param Rotation - Varaible used to store the return Rotation.
	*/
